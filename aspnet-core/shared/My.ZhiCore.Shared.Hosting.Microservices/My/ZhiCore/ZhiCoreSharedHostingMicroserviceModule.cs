...
public class ZhiCoreSharedHostingMicroserviceModule : AbpModule
{
    ...
    private void ConfigureAbpExceptions(ServiceConfigurationContext context)
    {
        ...
        (
            options =>
            {
                options.Filters.Add(typeof(ZhiCoreExceptionFilter));
                options.Filters.Add(typeof(ZhiCoreResultFilter));
            }
        );
    }
