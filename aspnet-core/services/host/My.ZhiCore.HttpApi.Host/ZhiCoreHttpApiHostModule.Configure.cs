...
public partial class ZhiCoreHttpApiHostModule
{
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.Events = new JwtBearerEvents
                {
                    OnMessageReceived = currentContext =>
                    {
                        ...
                        if (accessToken.IsNullOrWhiteSpace())
                        {
                            accessToken = currentContext.Request.Cookies[ZhiCoreHttpApiHostConst.DefaultCookieName];
                        }
    ...
    private void ConfigurationSignalR(ServiceConfigurationContext context)
    {
        context.Services
            ...
            .AddStackExchangeRedis(context.Services.GetConfiguration().GetValue<string>("Redis:Configuration"),
                options => { options.Configuration.ChannelPrefix = "My.ZhiCore"; });
    }
    ...
    private void ConfigureSwaggerServices(ServiceConfigurationContext context)
    {
        context.Services.AddSwaggerGen(
            options =>
            {
                ...
                options.SwaggerDoc("ZhiCore",
                    new OpenApiInfo { Title = "ZhiCore API", Version = "v1" });
    ...
    private void ConfigureCap(ServiceConfigurationContext context)
    {
        ...
        if (enabled)
        {
            context.AddAbpCap(capOptions =>
            {
                ...
                capOptions.UseEntityFramework<ZhiCoreDbContext>();
                ...
                {
                    options.AuthorizationPolicy = ZhiCoreCapPermissions.CapManagement.Cap;
                });
            });
        }
        else
    ...
    private void ConfigureAuditLog(ServiceConfigurationContext context)
    {
        ...
        (
            options =>
            {
                ...
                options.ApplicationName = "My.ZhiCore";
            }
        );
