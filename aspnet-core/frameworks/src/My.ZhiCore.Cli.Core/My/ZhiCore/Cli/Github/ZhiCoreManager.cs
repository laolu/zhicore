...
public class ZhiCoreManager : ITransientDependency, IZhiCoreManager
{
    private readonly ZhiCoreCliOptions _cliOptions;
    private readonly IHttpClientFactory _httpClientFactory;

    public ZhiCoreManager(IOptions<ZhiCoreCliOptions> options, IHttpClientFactory httpClientFactory)
    {
