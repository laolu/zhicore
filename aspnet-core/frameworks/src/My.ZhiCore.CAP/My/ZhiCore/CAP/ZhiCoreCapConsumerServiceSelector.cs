...
public class ZhiCoreCapConsumerServiceSelector : ConsumerServiceSelector, ISingletonDependency
{
    ...
    /// </summary>
    public ZhiCoreCapConsumerServiceSelector(IServiceProvider serviceProvider, IOptions<AbpDistributedEventBusOptions> distributedEventBusOptions) : base(serviceProvider)
    {
