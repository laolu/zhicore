...
public class ZhiCoreCapDistributedEventBus : EventBusBase, IDistributedEventBus, ISingletonDependency
{
    ...
    public ZhiCoreCapDistributedEventBus(IServiceScopeFactory serviceScopeFactory,
        ...
        bool useOutbox = true)
    {
        ...
        {
            if (UnitOfWorkManager.Current is not ZhiCoreCapUnitOfWork capUnitOfWork || capUnitOfWork.CapTransaction is null)
            {
