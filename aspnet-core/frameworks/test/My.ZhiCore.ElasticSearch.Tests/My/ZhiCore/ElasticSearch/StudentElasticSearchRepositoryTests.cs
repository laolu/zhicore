using My.ZhiCore.ElasticSearch.Exceptions;
using My.ZhiCore.ElasticSearch.Students;
using Nest;
using Shouldly;

namespace My.ZhiCore.ElasticSearch
{
    public sealed class StudentElasticSearchRepositoryTests : ZhiCoreElasticSearchTestBase
    {
        ...
        {
            await Should.ThrowAsync<ZhiCoreElasticSearchEntityNotFoundException>(async () => { await _studentElasticSearchRepository.GetAsync(Guid.NewGuid()); });
        }
