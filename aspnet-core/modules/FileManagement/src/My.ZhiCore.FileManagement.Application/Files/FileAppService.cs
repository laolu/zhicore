...
public class FileAppService : ApplicationService, IFileAppService
{
    ...
    private readonly IBlobContainer<ZhiCoreFileManagementContainer> _blobContainer;

    public FileAppService(FileObjectManager fileObjectManager, IBlobContainer<ZhiCoreFileManagementContainer> blobContainer, FileManager fileManager)
    {
