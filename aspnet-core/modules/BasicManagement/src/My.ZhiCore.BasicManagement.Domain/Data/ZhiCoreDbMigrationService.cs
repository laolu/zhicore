...
{
    public class ZhiCoreDbMigrationService : ITransientDependency
    {
        private ILogger<ZhiCoreDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IZhiCoreDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public ZhiCoreDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IZhiCoreDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<ZhiCoreDbMigrationService>.Instance;
        }
